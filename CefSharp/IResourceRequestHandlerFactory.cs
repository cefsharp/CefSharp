...
namespace CefSharp
{
    ...
    /// the <see cref="DefaultResourceRequestHandlerFactory"/> implementation that provides support
    ...
    public interface IResourceRequestHandlerFactory
    {
        ...
        IResourceRequestHandler GetResourceRequestHandler(IWebBrowser chromiumWebBrowser, IBrowser browser, IFrame frame, IRequest request, bool iNavigation, bool isDownload, string requestInitiator, ref bool disableDefaultHandling);
    }
}
