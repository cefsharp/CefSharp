...
namespace CefSharp
{
    ...
    public interface IDialogHandler
    {
        ...
        bool OnFileDialog(IWebBrowser browserControl, IBrowser browser, CefFileDialogMode mode, string title, string defaultFilePath, List<string> acceptFilters, out int selectedAcceptFilter, out List<string> result);
    }
}
