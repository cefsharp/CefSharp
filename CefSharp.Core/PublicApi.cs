...
namespace CefSharp
{
    ...
    public static class Cef
    {
        ...
        {
            return Core.Cef.Initialize(cefSettings);
        }
        ...
        {
            return Core.Cef.Initialize(cefSettings, performDependencyCheck);
        }
        ...
        {
            return Core.Cef.Initialize(cefSettings, performDependencyCheck, browserProcessHandler);
        }
        ...
        {
            return Core.Cef.Initialize(cefSettings, performDependencyCheck, cefApp);
        }
    ...
    public class RequestContextBuilder
    {
        ...
        public IRequestContext Create()
        {
            ...
            if (_settings != null)
            {
                return new CefSharp.Core.RequestContext(_settings, _handler);
            }
    ...
    public static class DragData
    {
        ...
        {
            return CefSharp.DragData.Create();
        }
    }
}
