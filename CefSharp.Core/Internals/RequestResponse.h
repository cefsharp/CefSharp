...
namespace CefSharp
{
    namespace Internals
    {
        ...
        private ref class RequestResponse : IRequestResponse
        {
            ...
            String^ _statusText;
            int _statusCode;
            IHeaderDictionary^ _responseHeaders;
        ...
        internal:
            ...
            property IHeaderDictionary^ ResponseHeaders { IHeaderDictionary^ get() { return _responseHeaders; } }
        ...
        public:
            ...
            virtual void RespondWith(Stream^ stream, String^ mimeType, String^ statusText, int statusCode, IHeaderDictionary^ responseHeaders);
        };
    }
}